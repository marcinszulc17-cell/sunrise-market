...
test("confirmed bookings can be dragged to another day", () => {
...
test("calendar drag keeps appointment time and daily length", () => {
...
test("dragging remains backed by the safe reschedule RPC", () => {
