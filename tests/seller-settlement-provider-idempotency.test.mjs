...
test("retry preserves the original seller payout idempotency namespace per provider", () => {
  ...
  assert.match(retry, /uuidv5\(`market:seller:\$\{row\.order_id\}:\$\{row\.seller_id\}`, namespace\)/);
});
