...
test("day calendar renders a 30 minute timeline", () => {
...
test("confirmed appointment bookings can be dropped on exact time slots", () => {
...
test("daily rentals remain day-based and are not moved on the hourly grid", () => {
