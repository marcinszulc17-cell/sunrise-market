...
function copy(event: string, recipient: string, p: any) {
  ...
  const map: Record<string, [string,string]> = {
    ...
    rescheduled: [seller ? "Termin rezerwacji został zmieniony" : "Nowy termin Twojej rezerwacji", seller ? "Termin rezerwacji został przełożony. Poniżej znajdziesz aktualny termin." : "Sprzedawca zmienił termin rezerwacji. Poniżej znajdziesz aktualną datę i godzinę."],
  };
