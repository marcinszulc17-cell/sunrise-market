-- FINAL PAID BOOKING REFUND PREPARE.
-- This intentionally runs after the 19:45 guard and keeps BOTH protections:
-- strongest financial guards + refund_pending seller payout lock.
