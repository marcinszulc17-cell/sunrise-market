...
-- Unpaid bookings may still be cancelled directly. Paid bookings must go through
-- the booking-refund Edge function so payment, bonus reversal and settlements
-- remain consistent.
