-- Final safety layer for paid booking refunds.
-- Keep the production payout lock (refund_pending), while also enforcing the
-- before-start/paid-order/held-deposit guards.
...
begin
  ...
  -- Freeze every unsettled seller payout before any external bonus/payment work.
