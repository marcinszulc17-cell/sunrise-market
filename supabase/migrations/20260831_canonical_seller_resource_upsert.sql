drop function if exists market.seller_booking_resource_update(uuid,text,text,text,boolean);
drop function if exists market.seller_booking_resource_update(uuid,text,text,boolean);
