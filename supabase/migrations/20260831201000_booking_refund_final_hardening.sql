-- Final canonical override for paid booking refunds. This migration intentionally
-- comes after earlier parallel refund migrations so a fresh replay cannot regress
...
begin
  ...
  set status='cancelled',
      last_error='Anulowana opłacona rezerwacja — zwrot klientowi',
      updated_at=now()
  ...
  where order_id=r.order_id
    and status in ('ready','sent','failed','pending_vat','pending_identity');
