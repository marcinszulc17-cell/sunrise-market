-- Align tracked migrations with the hardened paid-booking refund contract already used in production.
...
-- Return type is unchanged from the tracked contract, but DROP avoids conflicts with staged rollout versions.
