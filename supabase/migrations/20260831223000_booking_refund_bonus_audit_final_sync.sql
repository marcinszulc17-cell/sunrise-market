-- Final replay/live sync: earlier parallel refund migrations may overwrite booking_refunds_status_check.
-- Keep this migration after all 20260831 refund hardening overrides.
