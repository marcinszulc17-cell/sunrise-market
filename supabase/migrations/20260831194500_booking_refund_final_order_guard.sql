-- FINAL ORDER GUARD: this migration intentionally runs after the parallel 19:30 refund migration.
-- Automatic full refunds are only safe before the booking starts, for a truly paid order,
