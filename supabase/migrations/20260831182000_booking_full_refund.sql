-- Full paid-booking refund workflow.
-- Plain status cancellation is blocked for paid bookings; refunds must go through
-- booking-cancel-refund so money, bonuses, seller settlements and booking state
-- stay consistent.
