-- Do not rewrite booking_refund_finalize here: it already carries payout-lock and notification behavior.
-- Instead make the refund state machine enforce that money cannot be finalized as refunded
-- unless MySunrise cashback/commission reversal was durably recorded first.
