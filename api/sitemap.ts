...
export default async function handler(req: Request): Promise<Response> {
  ...
  const stat = [u("/", "daily", "1.0"), u("/sklep", "daily", "0.9"), u("/szukaj", "daily", "0.8"), u("/szukaj?tryb=appointment", "weekly", "0.7"), u("/nieruchomosci", "daily", "0.8"), u("/motoryzacja", "daily", "0.8"), u("/miasto", "weekly", "0.9"), u("/o-nas", "monthly", "0.5"), u("/pomoc", "monthly", "0.5"), u("/cennik", "monthly", "0.6"), u("/sprzedawca/dolacz", "monthly", "0.6"), u("/legal/regulamin.html", "yearly", "0.3"), u("/legal/prywatnosc.html", "yearly", "0.3"), u("/legal/kontakt.html", "yearly", "0.4")];
