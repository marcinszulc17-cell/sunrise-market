...
import Odbior from "./pages/Odbior";
import SellerPulse from "./pages/SellerPulse";
...
const NOINDEX_PREFIXES = ["/sprzedawca", "/operator", "/konto", "/portfel", "/koszyk", "/zamowienia", "/rezerwacje", "/odbior", "/login", "/sso", "/verify", "/potwierdz-zakup", "/szukaj", "/porownaj"];
