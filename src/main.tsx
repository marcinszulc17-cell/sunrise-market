...
const Praca = React.lazy(() => import("./pages/Praca"));
const TematLokalny = React.lazy(() => import("./pages/TematLokalny"));
const SellerApi = React.lazy(() => import("./pages/SellerApi"));
const DlaPartnerow = React.lazy(() => import("./pages/DlaPartnerow"));
const DlaObiektow = React.lazy(() => import("./pages/DlaObiektow"));
const Materialy = React.lazy(() => import("./pages/Materialy"));
