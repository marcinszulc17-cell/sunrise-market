  ...
  return <main className="min-h-screen px-4 py-8 sm:px-6" style={{ background: "var(--bg)", color: "var(--ink)" }}>
    <div className="mx-auto max-w-6xl">
      ...
      <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Link to="/sprzedawca/api" className="rounded-2xl p-5" style={{ background: "var(--glass)", border: "1px solid var(--line)" }}><div className="font-semibold">🔌 Integracje i API</div><div className="mt-1 text-sm" style={{ color: "var(--mut)" }}>Podłącz swój sklep, hurtownię albo integratora — oferty i zamówienia lecą automatycznie.</div></Link>
