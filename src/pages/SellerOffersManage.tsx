...
export default function SellerOffersManage() {
  ...
  return <Shell>
    <div className="mb-6 flex flex-wrap items-start justify-between gap-3">
      ...
      <Link to="/sprzedawca/wystaw" className="rounded-xl px-4 py-2 font-semibold text-black" style={{ background: "linear-gradient(135deg,#E8891A,#F5A623)" }}>+ Wystaw ofertę</Link>
    </div>
    ...
    {edit && <div className="mb-7 grid gap-5 xl:grid-cols-[1.25fr_.75fr]">
      ...
      <Card>
        ...
        <div className="mt-5 space-y-3">
          <Link to={`/sprzedawca/rezerwacje/ustawienia/${edit.offer_id}`} className="block rounded-xl px-4 py-3 text-center font-semibold text-black" style={{ background: "linear-gradient(135deg,#E8891A,#F5A623)" }}>Ustaw booking →</Link>
