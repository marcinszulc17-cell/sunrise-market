...
export default function SpecializedProduct() {
  ...
  return <div className="min-h-screen" style={{ background: "var(--bg)", color: "var(--ink)" }}>
    <header className="sticky top-0 z-30 backdrop-blur" style={{ background: "var(--header)", borderBottom: "1px solid var(--line)" }}>
      <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3"><a href="/"><img src="/logo-sunrise-market.png" alt="Sunrise Market" className="h-8 rounded-lg bg-white p-1" /></a><div className="flex-1" /><button onClick={() => navigator.share?.({ title: o.title, url: window.location.href })} className="rounded-xl px-3 py-2 text-sm" style={{ border: "1px solid var(--line)" }}>Udostępnij</button><a href="/" className="text-sm">← Wróć</a></div>
    </header>
    ...
    <main className="mx-auto max-w-7xl px-4 py-6 sm:py-8">
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_390px]">
        ...
        <aside className="lg:sticky lg:top-24 lg:h-fit">
          <div className="rounded-3xl p-5 shadow-2xl sm:p-6" style={{ background: "var(--glass)", border: "1px solid rgba(200,150,90,.22)" }}>
