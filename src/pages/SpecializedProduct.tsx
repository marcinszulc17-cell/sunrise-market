  ...
  return <div className="min-h-screen" style={{ background: "var(--bg)", color: "var(--ink)" }}>
    ...
    <main className="mx-auto max-w-7xl px-4 py-6 sm:py-8">
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_390px]">
        <section>
          <div className="overflow-hidden rounded-3xl" style={{ border: "1px solid var(--line)", background: "rgba(0,0,0,.16)" }}>
            {mainImage ? <img src={displayImageUrl(mainImage,1800)} alt={o.title} className="h-[430px] w-full object-contain sm:h-[540px]" /> : <div className="grid h-[430px] place-items-center text-8xl">{isCar ? "🚗" : isProperty ? "🏠" : "🌅"}</div>}
          </div>
