  ...
  return <div className="min-h-screen" style={{ background: "var(--bg)", color: "var(--ink)" }}>
    ...
    <main className="mx-auto max-w-[1440px] px-4 py-5 sm:px-6 xl:px-10">
      ...
      {o && <>
        ...
        <LocationMap location={typeof (o.attributes as any)?.location === "string" ? (o.attributes as any).location : null} radiusKm={Number((o.attributes as any)?.service_radius_km) || null} className="mt-6 max-w-xl" />
