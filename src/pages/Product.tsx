      ...
      {o && <>
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-wrap items-center gap-3"><div className="font-display text-4xl font-bold">{zl(o.price_gross)}{purchaseMode === "daily" ? <span className="text-base font-medium"> / dobę</span> : purchaseMode === "appointment" ? <span className="text-base font-medium"> / termin</span> : sub ? <span className="text-base font-medium"> {sub.priceSuffix}</span> : null}</div><span className="rounded-full px-3 py-1 text-sm font-semibold" style={{ background: "rgba(122,184,154,.12)", color: "var(--green)" }}>+{Math.round(o.price_gross * 0.03).toLocaleString("pl-PL")} pkt cashback</span></div>
