    ...
    <div className="grid gap-5 xl:grid-cols-[1.2fr_.8fr]">
      <Card>
        ...
        <div className="mt-4 space-y-4">
          ...
          <OfferDescriptionEditor value={offer.description ?? ""} onChange={(description) => setOffer({ ...offer, description })} title={offer.title} category={offer.category} images={offer.image_urls} />
