...
const TYPE_CONFIG: Record<string, { icon: string; title: string; subtitle: string; root?: string; fixedCategory?: string }> = {
  ...
  nieruchomosc: { icon: "🏠", title: "Wystaw nieruchomość", subtitle: "Sprzedaż lub rezerwacja pobytu / wynajmu z wyborem dat od–do w jednym formularzu.", root: "nieruchomosci" },
...
function modeDescription(mode: PurchaseMode) {
  ...
  if (mode === "daily") return "Klient wybiera daty od–do, widzi czynsz za cały okres i od razu opłaca rezerwację.";
