  ...
  async function publish() {
    ...
    try {
      ...
      const { data, error } = await supabase.rpc("create_offer_v2", {
        ...
        p_attributes: { ...attrs, ...(location.trim() ? { location: location.trim() } : {}), offer_type: type, purchase_mode: purchaseMode, full_vat_invoice: fullVatInvoice, vat_rate: Number(vatRate) },
      });
