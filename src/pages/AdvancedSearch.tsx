...
export default function AdvancedSearch(){
  ...
  return <main className="min-h-screen px-4 py-6 sm:px-6" style={{background:"var(--bg)",color:"var(--ink)"}}><div className="mx-auto max-w-7xl">
    ...
    <div className="mb-5 grid max-w-xl grid-cols-2 gap-2"><button onClick={()=>{setMode("car");reset();}} className="rounded-xl p-3 font-semibold" style={mode==="car"?{background:"linear-gradient(135deg,#C8965A,#E8C896)",color:"#000"}:box}>🚗 Samochody</button><button onClick={()=>{setMode("property");reset();}} className="rounded-xl p-3 font-semibold" style={mode==="property"?{background:"linear-gradient(135deg,#C8965A,#E8C896)",color:"#000"}:box}>🏠 Nieruchomości</button></div>
