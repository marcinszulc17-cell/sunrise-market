...
export default function CategoryPortal({mode}:{mode:Mode}){
  ...
  return <main className="min-h-screen" style={{background:"var(--bg)",color:"var(--ink)"}}>
    ...
    {!searched&&latest.length===0&&<PustyWynik car={car} tytul={car?"Nie ma jeszcze ogłoszeń motoryzacyjnych":"Nie ma jeszcze ogłoszeń nieruchomości"} opis="Ten dział dopiero się zapełnia. Nie pokazujemy wyników, których nie ma — ale możesz być pierwszy."/>}
