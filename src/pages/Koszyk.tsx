        ...
        {done ? (
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="rounded-2xl p-5 h-fit" style={{ background: "var(--glass)", border: "1px solid var(--line)" }}>
              ...
              <p className="text-xs mt-3" style={{ color: "var(--mut)" }}>Cashback {cashbackPct}% wraca na portfel Sunrise Pay przy każdej metodzie płatności — saldem albo kartą. Subskrypcje rozliczane są przez Stripe (karta).</p>
            </div>
          </div>
