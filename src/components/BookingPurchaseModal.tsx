      ...
      <div className="grid flex-1 overflow-y-auto lg:grid-cols-[1fr_330px]">
        ...
        <aside className="border-t p-5 lg:border-l lg:border-t-0 lg:p-6" style={{ borderColor: "var(--line)", background: "color-mix(in srgb, var(--glass) 55%, transparent)" }}>
          <div className="lg:sticky lg:top-0">
            ...
            {deposit > 0 && <div className="mt-3 text-xs" style={{ color: "var(--mut)" }}>Kaucja {zl(deposit)} jest wliczona w kwotę płatności, nie jest naliczana do cashbacku i po zakończeniu podlega zwrotowi albo rozliczeniu przez sprzedawcę.</div>}
